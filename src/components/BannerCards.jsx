const Card = ({ imageSrc, title, description, color, height, width , circle, textSize, descSize}) => {
    return (
        <div className={`shadow-black shadow-sm border rounded-tl-xl rounded-tr-3xl rounded-br-xl rounded-bl-xl ${height} ${width} p-4 flex flex-col items-start transform transition-transform duration-300 hover:scale-105 ${color}`}>
