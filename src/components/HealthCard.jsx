  ...
  return (
    <div className='h-60 w-96 border-2 overflow-hidden' id={`card-${member._id}`}>
      ...
      <div className='relative'>
        ...
        <div className='absolute' style={{ left: '125px', bottom: '-66px' }}>
          <div>
          ...
          <div className='flex items-center'>
            ...
            <p className='text-custom1 font-medium'>{member.emergencyNumber}</p>
          </div>
          <div className='flex items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-3 mr-1">
            ...
            <p className='text-custom1 font-medium'>guwahati{member.address}</p>
          </div>
        </div>
        ...
        <div className='absolute' style={{ left: '270px', top: '75px' }}>
          <p className='text-custom1 font-medium'>{member.abhaId}</p>
        </div>
