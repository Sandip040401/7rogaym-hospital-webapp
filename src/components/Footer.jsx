        ...
        <footer className="bg-gradient-to-r from-teal-100 to-cyan-100 text-white pt-10 px-6 lg:px-20" id="contact">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    ...
                    <input
                        className="shadow appearance-none border border-gray-700 rounded w-full py-2 px-3 bg-white text-gray-500 leading-tight focus:outline-none focus:shadow-outline"
                        id="name"
                        type="text"
                    ...
                    >
                        {loading ? (
                            <span className="flex items-center">
                                <svg className="animate-spin h-5 w-5 mr-3 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 0 1 16 0 8 8 0 0 1-16 0z"></path></svg>
                                Sending...
                            </span>
                        ) : (
                            'Send Message'
                ...
                {formState.success && (
                    ...
                    <div>
                        <div className='mt-20'>
                            {/* <h2 className="text-3xl text-black font-bold mb-4">7Rogyam Healthcare (P) Ltd</h2> */}
                            <div className="flex flex-col space-y-2">
                                ...
                                <a href="tel:01169290540" className="text-black text-xl md:text-2xl font-semibold hover:text-slate-500">011-69290540</a>
                                <div className="flex items-center">
                                    <FaEnvelope className="text-red-500 mr-2 text-2xl" />
                                    <p className="text-gray-500 text-xl md:text-2xl font-semibold">Email:</p>
                                </div>
                                <a href="mailto:Contact@7Rogyam.com" className="text-black text-xl md:text-2xl font-semibold hover:text-slate-500">Contact@7Rogyam.com</a>
                            </div>
                        </div>
                    </div>
                </div>

                <div className="flex flex-col-reverse md:flex-row-reverse items-center mt-8">
                    <div>
                        <div className="mt-4 text-center md:text-right">
                            <Link to="/tnc" className="text-black hover:text-blue-500 transition duration-300">Terms & Conditions</Link>
                            <span className="mx-2 text-gray-500">|</span>
                            <Link to="/privacy-policy" className="text-black hover:text-blue-500 transition duration-300">Privacy Policy</Link>
                            <span className="mx-2 text-gray-500">|</span>
                            <Link to="/refund" className="text-black hover:text-blue-500 transition duration-300">Refund & Cancellation</Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <div className='mt-2'>
                            <div className="flex space-x-4">
                                <a href="https://www.facebook.com/7Rogyam" className="text-gray-500 hover:text-blue-500" target="_blank" rel="noopener noreferrer">
                                ...
                                <a href="https://www.instagram.com/7Rogyam" className="text-gray-500 hover:text-pink-500" target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="https://x.com/7Rogyam" className="text-gray-500 hover:text-blue-700" target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="https://www.youtube.com/@7Rogyam" className="text-gray-500 hover:text-red-500" target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
