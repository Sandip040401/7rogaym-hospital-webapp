...
export default function Policy() {
    return (
        <>
            <AppBar />
            <div className="w-full mt-10 p-20 bg-white shadow-lg rounded-lg">
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li><strong>To provide You</strong> with news, special offersinformative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.</li>
