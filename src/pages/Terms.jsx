...
export default function Terms() {
    return (
        <>
            <AppBar />
            <div className="px-12 lg:px-48 pb-20 pt-36  bg-[url('/background.jpg')] lg:bg-[url('/services.jpg')] bg-repeat bg-contain min-h-screen flex items-center justify-center">
                <div className="bg-white p-10 rounded-xl shadow-2xl ">           
                <h1 className="text-3xl lg:text-4xl flex justify-center font-bold mb-4">Terms & Conditions</h1>
                <p className='text-lg'>
                ...
                <ol className="list-decimal lg:ml-10 mt-2">
